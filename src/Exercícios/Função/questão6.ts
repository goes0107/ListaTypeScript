...
export function questao6funcao(): void {
        ...
        let descontoIR = salarioBruto * percentualIR
        ...
        console.log(`Salário Bruto: (${valorHora} * ${horas}) : R$ ${salarioBruto.toFixed(2)}`)
        console.log(`(-) IR (${percentualIR * 100}%) : R$ ${descontoIR.toFixed(2)}`)
        console.log(`(-) INSS (10%) : R$ ${inss.toFixed(2)}`)
        console.log(`(-) Sindicato (3%) : R$ ${sindicato.toFixed(2)}`)
        console.log(`(-) Vale Alimentação (8%) : R$ ${valeAlimentacao.toFixed(2)}`)
        console.log(`(-) Vale Transporte (6%) : R$ ${valeTransporte.toFixed(2)}`)
